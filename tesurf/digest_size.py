class DigestSize:
    ...
    @staticmethod
    def new_relative(relative_part: float)->'DigestSize':
        return DigestSize(is_relative=True, relative_part=relative_part)

    @staticmethod
    def new_absolute(absolute_size: int)->'DigestSize':
        return DigestSize(is_relative=False, absolute_size=absolute_size)
